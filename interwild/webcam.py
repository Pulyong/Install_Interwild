...
# snapshot load
model_path = f'../output/model_dump/snapshot_{args.model_num}.pth'
...
while(True):
    ...
    if args.save_frame:
        ...
        cv2.imwrite(osp.join(render_save_path, file_name + '_total.jpg'), np.concatenate((vis_box,vis_skeleton,render_out[0].cpu().numpy()), axis=1))
